			...
			<div class="container py-5">
				...
				<div class="row py-3">
					...
					<div class="col-md-5 col-sm-5 col-xs-8">
						<!-- Start Map -->
						<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d1013888.9392140873!2d107.1524341!3d-6.9497584!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x3c7834a22ae3b734!2sPT%20KINETA%20JAYA%20ABADI!5e0!3m2!1sid!2sid!4v1625643803343!5m2!1sid!2sid" width="100%" height="380" frameborder="0" style="border:0" allowfullscreen></iframe>
						<!-- End Map -->
					</div>
					<!-- End Google Map -->
					...
					<div class="col-md-7 col-sm-7 col-xs-12">
						<div class="row">
							...
							<div class=" col-md-4 col-sm-4 col-xs-12">
								<div class="contact-icon text-center">
									<div class="single-icon" id="sosmedicon">
										...
										<p>
											Location: <br>Jl. Buncis No.6, Cikole, Lembang<br>
											<span>Kabupaten Bandung Barat <br> Jawa Barat, Indonesia</span>
										</p>
									</div>
								</div>
							</div>
							...
							<div class="col-md-4 col-sm-4 col-xs-12">
								<div class="contact-icon text-center">
									<div class="single-icon" id="sosmedicon">
										<a target="_blank" href="http://api.whatsapp.com/send?phone=6281222137799&text=Hallo%20Kak,%20Pengen%20tau%20lebih%20lanjut%20tentang%20program%20magang%20di%20LPK%20Kinjadi">
							...
							<div class="col-md-4 col-sm-4 col-xs-12">
								<div class="contact-icon text-center">
									<div class="single-icon" id="sosmedicon">
										<a target="_blank" href="https://mail.google.com/mail/?view=cm&fs=1&to=kinetajayaabadi@gmail.com&su=Tanya lpk">
											<i class="fa fa-envelope-o " style="font-size:48px"></i>
										</a>
										<p>
											Email: KinetaJayaAbadi@gmail.com<br>
										</p>
									</div>
								</div>
							</div>
							...
							<div class="col-md-4 col-sm-4 col-xs-12">
								<div class="contact-icon text-center">
									<div class="single-icon" id="sosmedicon">
										<a target="_blank" href="https://www.facebook.com/lpk.kinjadi/">
							...
							<div class="col-md-4 col-sm-4 col-xs-12">
								<div class="contact-icon text-center">
									<div class="single-icon" id="sosmedicon">
										<a target="_blank" href="https://www.instagram.com/lpkkinjadi/">
